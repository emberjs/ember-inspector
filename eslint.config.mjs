...
export default ts.config(
   ...
   */
  {
    ignores: [
      ...
      'ember_debug_test_app/public/',
      'ember_debug_test_app/tests/helpers/index.ts',
      'coverage/',
      '!**/.*',
      'vendor/',
      'dist_prev/',
  ...
  },
  {
    files: [
      ...
      'ember_debug_test_app/tests/**/*-test.{js,gjs,ts,gts}',
    ],
    plugins: {
      qunit,
    },
   ...
   */
  {
    files: [
      '**/*.cjs',
      'config/**/*.js',
      'ember_debug_test_app/config/**/*.js',
      'lib/*/index.js',
      'scripts/**/*.js',
      'testem.js',
      'ember_debug_test_app/testem.js',
      'testem*.js',
      '.prettierrc.js',
      '.stylelintrc.js',
      '.template-lintrc.js',
